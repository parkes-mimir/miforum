...
- 收藏功能（帖子列表/详情页收藏按钮，TA的收藏 Tab）
- 新增 `POST/DELETE/GET /api/bookmark` 接口

### v0.5.0 (2026-08-31) — 贡献者: parkes-mimir

- 个人资料系统（头像裁剪、简介、隐私、TA的帖子/点赞 Tab）
- 新增 `GET /api/users/:id`、`PUT /api/profile`、`GET /api/users/:id/likes`
